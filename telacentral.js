        ...
        <View style={estilos.cxPrincipal}>
                <View style={estilos.titulo}>
                        <View>
                            ...
                            <Text style={{color: "white", fontSize: 20}}>Fulano de tal</Text>
                        </View>
                        <View style={estilos.tituloCirculo}>
                            <Ionicon name="person" size={30} color={"gray"}/>
                        </View>
                </View>
                <View style={estilos.cxmeio}>
                    <View style={estilos.meioRequerimento}>
                        <Text style={{color: "white", fontSize: 15, alignItems:"center"}}>Requerimentos</Text>
                    </View>
                    <View style={estilos.meioNotas}>
                        <Text style={{color: "white", fontSize: 15}}>Notas</Text>
                    </View>
                </View>  
                ...
                <View style={estilos.cxmeio2}>
                    <View style={estilos.meioFrequencia}>
                        <Text style={{color: "white", fontSize: 15, alignItems:"center"}}>Frequência</Text>
                    </View>
                <View style={estilos.meioAvaliacoes}>
                        <Text style={{color: "white", fontSize: 15}}>Avaliações</Text>
                    </View>
                </View>  
                ...
                <View style={estilos.cxmeio3}>
                    <View style={estilos.meioFinanceiro}>
                        <Text style={{color: "white", fontSize: 15, alignItems:"center"}}>Financeiro</Text>
                    </View>
                    <View style={estilos.meioDocumentos}>
                        <Text style={{color: "white", fontSize: 15}}>Documentos</Text>
                    </View>
                </View>  
